...
update-available prompt (07), word-level LRC (09), the chromatic tuner (12), the
light theme with motion preferences (17), the same-tab mutation lease (26) and
the `ensureWaveform` race (27). Item 14 is still here because only half of it was
done — the touch ergonomics, not the iPad Safari verification.
