...
import { CloudSlash, Cpu, Database, DownloadSimple, ShieldCheck, UploadSimple, Waveform } from "@phosphor-icons/react";
...
const modelErrorMessage = (code: string) => modelErrors[code] ?? `The model operation stopped safely (${code}). Your setup is unchanged.`;
