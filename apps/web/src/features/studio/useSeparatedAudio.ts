...
const recordingErrors: Record<string, string> = {
  ...
  recording_permission_denied: "Recording needs microphone access. Allow the microphone for this site, then start a new take.",
