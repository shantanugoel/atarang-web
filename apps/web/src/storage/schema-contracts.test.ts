...
describe("canonical JSON Schema corpus",()=>{
  test("every committed schema compiles as JSON Schema 2020-12",async()=>{
    ...
    expect(names.sort()).toEqual(["backup-manifest-v1.json","beat-grid-v1.json","chord-analysis-v1.json","correction-layer-v1.json","lyrics-document-v1.json","model-artifact-manifest-v1.json","original-v1.json","performance-manifest-v1.json","practice-state-v1.json","separation-manifest-v1.json","user-chart-v1.json","user-chord-v1.json"]);
  });
});
